@echo off
 ...
 doskey py27_install=D:\64\Python27\python.exe -m pip install dist\gmpy2-2.1.3-cp27-cp27m-win_amd64.whl --force-reinstall
 doskey py35_install=D:\64\Python35\python.exe -m pip install dist\gmpy2-2.1.3-cp35-cp35m-win_amd64.whl --force-reinstall
 doskey py36_install=D:\64\Python36\python.exe -m pip install dist\gmpy2-2.1.3-cp36-cp36m-win_amd64.whl --force-reinstall
 doskey py37_install=D:\64\Python37\python.exe -m pip install dist\gmpy2-2.1.3-cp37-cp37m-win_amd64.whl --force-reinstall
 doskey py38_install=D:\64\Python38\python.exe -m pip install dist\gmpy2-2.1.3-cp38-cp38-win_amd64.whl --force-reinstall
 doskey py39_install=D:\64\Python39\python.exe -m pip install dist\gmpy2-2.1.3-cp39-cp39-win_amd64.whl --force-reinstall
 doskey py310_install=D:\64\Python310\python.exe -m pip install dist\gmpy2-2.1.3-cp310-cp310-win_amd64.whl --force-reinstall
 doskey py311_install=D:\64\Python311\python.exe -m pip install dist\gmpy2-2.1.3-cp311-cp311-win_amd64.whl --force-reinstall

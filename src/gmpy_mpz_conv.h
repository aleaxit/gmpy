...
static unsigned long culong_From_Integer(PyObject *obj);
#else
static long long clonglong_From_Integer(PyObject *obj);
static unsigned long long culonglong_From_Integer(PyObject *obj);
#endif

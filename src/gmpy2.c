...
static PyMethodDef Pygmpy_methods [] =
{
    ...
    { "bincoef", GMPy_MPZ_Bincoef, METH_VARARGS, GMPy_doc_mpz_function_bincoef },
    { "comb", GMPy_MPZ_Bincoef, METH_VARARGS, GMPy_doc_mpz_function_comb },
    ...
    { "iroot", GMPy_MPZ_Iroot, METH_VARARGS, GMPy_doc_mpz_iroot },
    { "iroot_rem", GMPy_MPZ_IrootRem, METH_VARARGS, GMPy_doc_mpz_iroot_rem },
    ...
    { "num_digits", GMPy_MPZ_NumDigits, METH_VARARGS, GMPy_doc_mpz_function_num_digits },

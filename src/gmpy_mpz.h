...
static Py_ssize_t Pympz_nbits(PympzObject *obj);
...
static PyObject * Pympz_addmul(PyObject *self, PyObject *args);
static PyObject * Pympz_submul(PyObject *self, PyObject *args);

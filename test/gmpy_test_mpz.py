...
['binary', 'bincoef', 'bit_length', 'cdiv2exp', 'cmod2exp', 'comb', 'copy', 'digits', 'divexact', 'fdiv2exp', 'fmod2exp', 'getbit', 'hamdist', 'invert', 'is_even', 'is_odd', 'is_power', 'is_prime', 'is_square', 'jacobi', 'kronecker', 'legendre', 'next_prime', 'numdigits', 'popcount', 'qdiv', 'remove', 'root', 'rootrem', 'scan0', 'scan1', 'setbit', 'sign', 'sqrt', 'sqrtrem', 'tdiv2exp', 'tmod2exp']
>>>
'''

...
static PyMethodDef GMPyContext_methods[] =
{
    ...
    { "cot", GMPy_Context_Cot, METH_VARARGS, GMPy_doc_context_cot },
    { "coth", GMPy_Context_Coth, METH_VARARGS, GMPy_doc_context_coth },
    { "copy", GMPy_CTXT_Copy, METH_NOARGS, GMPy_doc_context_copy },
    { "csc", GMPy_Context_Csc, METH_VARARGS, GMPy_doc_context_csc },
    { "csch", GMPy_Context_Csch, METH_VARARGS, GMPy_doc_context_csch },
    ...
    { "exp", GMPy_Context_Exp, METH_VARARGS, GMPy_doc_context_exp },
    ...
    { "sec", GMPy_Context_Sec, METH_VARARGS, GMPy_doc_context_sec },
    { "sech", GMPy_Context_Sech, METH_VARARGS, GMPy_doc_context_sech },

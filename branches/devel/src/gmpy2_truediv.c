 ...
 * Private API
 * ===========
 *   GMPy_mpz_truediv_fast; called by + via the nb_add slot of mpz
 *   GMPy_mpq_truediv_fast; called by + via the nb_add slot of mpq
 *   GMPy_mpfr_truediv_fast; called by + via the nb_add slot of mpfr
 *   GMPy_mpc_true_fast; called by + via the nb_add slot of mpc
 *

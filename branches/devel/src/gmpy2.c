...
static PyMethodDef Pygmpy_methods [] =
{
    ...
    { "acosh", GMPy_Function_Acosh, METH_O, GMPy_doc_function_acosh },
    { "ai", Pympfr_ai, METH_O, doc_g_mpfr_ai },
    { "agm", Pympfr_agm, METH_VARARGS, doc_g_mpfr_agm },
    { "asin", Pympany_asin, METH_O, doc_mpany_asin },
    { "asinh", GMPy_Function_Asinh, METH_O, GMPy_doc_function_asinh },
    { "atan", GMPy_Function_Atan, METH_O, GMPy_doc_function_atan },
    ...
    { "cos", GMPy_Function_Cos, METH_O, GMPy_doc_function_cos },
    { "cosh", GMPy_Function_Cosh, METH_O, GMPy_doc_function_cosh },
    ...
    { "sinh", GMPy_Function_Sinh, METH_O, GMPy_doc_function_sinh },
    ...
    { "tan", GMPy_Function_Tan, METH_O, GMPy_doc_function_tan },
    { "tanh", GMPy_Function_Tanh, METH_O, GMPy_doc_function_tanh },

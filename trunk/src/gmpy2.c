...
static PyMethodDef Pygmpy_methods [] =
{
    ...
    { "is_extrastronglucas_prp", GMPY_mpz_is_extrastronglucas_prp, METH_VARARGS, doc_mpz_is_extrastronglucas_prp },
    ...
    { "is_stronglucas_prp", GMPY_mpz_is_stronglucas_prp, METH_VARARGS, doc_mpz_is_stronglucas_prp },

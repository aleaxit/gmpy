...
>>> _g.mpfr(_g.binary(_g.mpfr(2.0)), 0, 256) == 2.0
1
>>> prec=_g.get_mpfr_precision()
>>> _g.set_mpfr_precision(prec)
>>> a.precision==prec
1
>>> b.precision==prec
1

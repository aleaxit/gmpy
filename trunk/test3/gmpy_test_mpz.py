...
>>> float('nan') / a
mpfr('nan')
>>> _g.set_mode(_g.ModeRaise)
>>> float('nan') / _g.mpz(0)
Traceback (most recent call last):
  ...
ZeroDivisionError: mpfr division by zero
>>> _g.set_mode(_g.ModeNonStop)
>>> float('nan') / _g.mpz(0)
mpfr('nan')
>>> divmod(a, float('Inf'))
